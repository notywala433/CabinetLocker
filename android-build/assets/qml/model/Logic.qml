...
Item {
    ...
    signal openCabinet(var cabinetNumber, var prescription)
    ...
    //Find prescription
    signal findPrescription(var id)

    //send an sms to client
    signal sendSMS(var prescription,var vacantlock)

    //Admin open and reset lock
    signal resetLocker(var prescription)
